...
"""
03_bilstm.py
Improved model: Bi-directional LSTM
...
def build_bilstm_model(vocab_size, embedding_dim, embedding_matrix, max_length, lstm_units=100):
...
def main():
    ...
    model = build_bilstm_model(vocab_size, args.embedding_dim, embedding_matrix,
